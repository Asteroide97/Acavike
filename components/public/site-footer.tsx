...
export function SiteFooter({
  ...
  return (
    <footer className="mt-12 bg-[#081632] text-slate-200">
      <div className="section-shell grid gap-10 py-12 md:grid-cols-2 xl:grid-cols-[1.25fr_0.85fr_0.85fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-sm text-[13px] leading-6 text-slate-300">
            Catalogo industrial B2B para compras directas, cotizaciones de volumen y atencion operativa para empresas.
          </p>
        ...
        <div>
          ...
          <div className="mt-4 grid gap-4 text-[13px] leading-6 text-slate-200">
            <div>
              <p className="font-semibold text-white">Telefono comercial</p>
              <p>{phone}</p>
            </div>
            <div>
      ...
      <div className="border-t border-white/10">
        <div className="section-shell flex flex-col gap-2 py-4 text-[12px] text-slate-400 md:flex-row md:items-center md:justify-between">
          <p>Acavike. Plantilla comercial B2B con catalogo industrial y compra por transferencia.</p>
